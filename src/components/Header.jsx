...
export const Header = () => {
  ...
  return (
    <header className=" px-5  py-3 pl-[20px]">
      {/*HEADER*/}
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
        ...
        <form action="">
          <div className=" w-full relative">
            ...
            <input
              type="text"
              className=" w-full pl-10 py-2 pr-4 text-gray-300 bg-[#1F1D2B] rounded-full focus:outline-none "
              placeholder="Search "
            />
          </div>
        </form>
      ...
      {/*Tabs*/}
      <nav className=" text-gray-300 flex items-center justify-between md:justify-start md:gap-8 mb-10">
        <a
          href="#"
